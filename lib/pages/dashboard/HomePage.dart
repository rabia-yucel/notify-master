...
class _HomePageState extends State<HomePage> {
    ...
    await FirebaseFirestore.instance
      ...
      querySnapshotUN.docs.forEach((docUN) async {
        await FirebaseFirestore.instance
          ...
          dashboardNotificationsModelList
              .sort((a, b) => b.instanceTime.compareTo(a.instanceTime));
        });
      });
    });
  }
  ...
  buildDashboardMessageNotifications(
      BuildContext context, DashboardNotificationsModel data) {
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: IconButton(
                            onPressed: () {
                              updateNotificationAsDeleted(data);
                            },
                            icon: const Icon(
  ...
  Future<void> updateNotificationAsDeleted(
      DashboardNotificationsModel data) async {
    await FirebaseFirestore.instance
        .collection('user_notifications')
        .where('phone_number', isEqualTo: SessionDataManager.getPhoneNumber())
      ...
      querySnapshot.docs.forEach((doc) {
        doc.reference
            .update({'is_deleted': true, 'update_time': DateTime.now()});
      });
    });
